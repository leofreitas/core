        ...
        if ($ACK == 'Success') {
            ...
            if (count($emails) > 0) {
                //Get receipt number
                    ...
                    $sqlPayments = 'SELECT gibbonPayment.*, preferredName, surname FROM gibbonPayment JOIN gibbonPerson ON (gibbonPayment.gibbonPersonID=gibbonPerson.gibbonPersonID) WHERE foreignTable=:foreignTable AND foreignTableID=:foreignTableID ORDER BY timestamp, gibbonPaymentID';
